								...
								<div class="grid gap-4 mb-4 grid-cols-2">
									<div class="col-span-2 sm:col-span-1">
										...
										<input
											...
											name="price"
											id="price"
											class="text-right bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
											placeholder="0,00"
											required={true}
										/>
									</div>
											...
											<For each={allCurrencies}>
												{(i) => (
													<option
														...
														onClick={() => setCurrency(i.currency_code)}
													>
									...
									<div class="col-span-2">
										...
										<div class="grid grid-cols-3 md:grid-cols-3 gap-0">
											<For each={allCategories}>
												{(i) => (
													<CardWithIcon title={i.name} icon={<StarIcon />} />
												)}
											</For>
											<CardWithIcon
												title="Add category"
